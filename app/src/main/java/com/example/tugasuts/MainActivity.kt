...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnKirim = findViewById(R.id.btnCancel)   // pada layout btnCancel bertuliskan "Kirim"
        btnBatal = findViewById(R.id.btnSubmit)   // pada layout btnSubmit bertuliskan "Batal"
